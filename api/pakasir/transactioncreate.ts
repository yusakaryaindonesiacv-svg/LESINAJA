// Vercel Serverless Function: Pakasir Transaction Create (Catch-all)
// Path: /api/pakasir/transactioncreate
// Supports: /api/pakasir/transactioncreate, /api/pakasir/transactioncreate?method=qris, /api/pakasir/transactioncreate/:method
...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    console.error('[Vercel Serverless] Error in transactioncreate handler:', err);
